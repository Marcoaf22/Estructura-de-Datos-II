...
public class Grafo {    //Grafo dirigido y con peso 
    ...
    public void marcarIslaDelVertice(int u) {
        dfs(u);
        int posicionDeVertice = getVerticeNoMarcado();;
        while (posicionDeVertice != -1) {
            dfs1(posicionDeVertice);
            posicionDeVertice = getVerticeNoMarcado();
        }
