...
public class Main {
    ...
    private static final int[] A = {0, 15, 3, 0, 25, 2, 1, 50, 6, 3, 20, 1, 3, 5, 4, 3, 30, 6, 4, 10, 0, 4, 35, 2, 5, 25, 0, 5, 10, 3, 5, 20, 4, 6, 5, 1, 6, 12, 2, 8, 10, 7};
    ...
    public static void main(String[] args) {
        ...
        G.printListas();
//G.alcanza(3, new int[]{5, 10, 15, 30});
        //Pruebe aquí su método
        System.out.println(G.alcanza(3, new int[]{5,10,15,30}));
    }
